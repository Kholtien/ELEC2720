...
*/
# define INTERRUPT_GEN_ERROR ((0 x01U )) // The interrupt generated an error
# define RX_BUFFER_FULL ((0 x01U ) << 1) // Rx buffer is full upon receive interrupt
...
uint16_t fuinGetAllChars(stSERIAL_CHANNELTypeDef *pstSerialCh, char *pchString, uint16_t inMaxStringSize);
