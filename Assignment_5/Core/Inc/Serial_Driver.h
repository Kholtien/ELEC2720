 ...
 *  Modified on: $Date: 2021-03-23 08:23:53 +1100 (Tue, 23 Mar 2021) $ UTC
 ...
 * Function Prototypes
 */
extern stSERIAL_CHANNELTypeDef *pstCreateSerialChannel(UART_HandleTypeDef *pstHuart, uint16_t uinRxBufSize, uint16_t uinTxBufSize);
